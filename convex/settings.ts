    ...
    handler: async (ctx, args) => {
        ...
        if (existing) {
            ...
            await ctx.db.insert("settings", {
                ...
                priceMatch: args.priceMatch ?? 0.25,
                priceDaily: args.priceDaily ?? 0.50,
                priceWeekly: args.priceWeekly ?? 1.50,
                priceMonthly: args.priceMonthly ?? 3,
                priceYearly: args.priceYearly ?? 20,
