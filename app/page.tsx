...
export default function HomePage() {
    ...
    return (
      <div className="container mx-auto px-4 py-8 space-y-12">
        ...
        <div className="relative w-full h-[65vh] md:h-[70vh] rounded-3xl overflow-hidden bg-stadium-elevated border border-white/5">
          ...
          <div className="absolute bottom-12 left-8 space-y-4 w-1/2">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {[...Array(3)].map((_, i) => (
              <div key={i} className="h-32 rounded-xl border border-white/5 bg-stadium-elevated p-4 flex flex-col justify-between">
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {[...Array(6)].map((_, i) => (
              <div key={i} className="aspect-[2/3] rounded-xl overflow-hidden bg-stadium-elevated border border-white/5 relative">
                <Skeleton className="w-full h-full" />
              </div>
            ))}
          </div>
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {/* Live Now */}
      <Section title="LIVE HADA" icon={PlayCircle} color="bg-accent-red/20 text-accent-red" count={live.length} link="/ciyaar">
        {live.length > 0 ? (
