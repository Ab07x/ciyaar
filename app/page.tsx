    ...
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10">
        ...
        <div className="relative w-full h-[85vh] md:h-[90vh] overflow-hidden">
          ...
          {/* Current Movie Backdrop - Blend with theater background */}
          {currentMovie && (
                ...
                >
                  <div className="relative aspect-[2/3] rounded-xl overflow-hidden bg-stadium-elevated border border-border-subtle group-hover:border-accent-green/50 transition-all duration-300 shadow-lg">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-all duration-300">
                      <div className={`w-14 h-14 rounded-full flex items-center justify-center shadow-xl transform scale-50 group-hover:scale-100 transition-transform duration-300 ${movie.isPremium && !isPremium ? 'bg-accent-gold text-black' : 'bg-white/90 text-black'}`}>
