...
import { CheckCircle2, XCircle, Loader2, Crown, ArrowRight, RefreshCw } from "lucide-react";
...
function PaymentVerifier() {
    ...
    useEffect(() => {
        if (!sid && !orderId) {
            setStatus("error");
            setMessage("Macluumaad lacag bixin ah lama helin.");
            return;
        }

        verifyPayment();
    }, [sid, orderId, retryCount]);
            ...
            <div className="max-w-md w-full">
                ...
                {status === "success" && (
                    <div className="text-center animate-in fade-in duration-500">
                        ...
                        <p className="text-accent-green text-lg font-bold mb-2">{message}</p>
                        {plan && (
