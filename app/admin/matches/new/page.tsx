...
export default function MatchFormPage({ params }: Props) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const data = { ...formData, kickoffAt: kickoff, thumbnailUrl: formData.thumbnailUrl || undefined, summary: formData.summary || undefined };
