...
export default function NewBannerPage() {
    ...
    const createBanner = useMutation(api.promoBanners.createBanner);
                ...
                <div className="bg-stadium-elevated border border-border-strong rounded-xl p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="e.g. Black Friday 2024, New Year Sale"
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className="w-full bg-stadium-dark border border-border-subtle rounded-lg px-4 py-3"
                        >
                            <option value="main">Main Banner (below hero/videos)</option>
                            <option value="small">Small Inline Banner</option>
