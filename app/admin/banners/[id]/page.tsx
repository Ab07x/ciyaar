...
export default function EditBannerPage() {
    ...
    const id = params.id as Id<"promo_banners">;

    const banner = useQuery(api.promoBanners.getBannerById, { id });
    ...
    useEffect(() => {
        if (banner) {
            setFormData({
                ...
                backgroundColor: banner.backgroundColor || "#1a3a5c",
        ...
        <div className="max-w-4xl space-y-6 pb-20">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    <Link href="/admin/banners" className="p-2 hover:bg-stadium-hover rounded-lg transition-colors">
                        <ArrowLeft size={24} />
                    </Link>
                    <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-stadium-elevated border border-border-strong rounded-xl p-6 space-y-4">
                    ...
                    <div>
                        <label className="block text-sm text-text-secondary mb-2">Banner Name</label>
                        <input
                            value={formData.name}
                    ...
                    <div>
                        ...
                        >
                            ...
                            <option value="small">Small Inline</option>
                            <option value="popup">Popup Modal</option>
                            <option value="interstitial">Full-screen Interstitial</option>
                        </select>
                    </div>
                ...
                <div className="bg-stadium-elevated border border-border-strong rounded-xl p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="Ads suck but keep the site free."
                            className="w-full bg-stadium-dark border border-border-subtle rounded-lg px-4 py-3"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            placeholder="Remove ads and get many features..."
                            className="w-full bg-stadium-dark border border-border-subtle rounded-lg px-4 py-3"
                        />
                    </div>
                ...
                <div className="bg-stadium-elevated border border-border-strong rounded-xl p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) => setFormData({ ...formData, leftImageUrl: e.target.value })}
                            placeholder="/img/dragon-left.png"
                            className="w-full bg-stadium-dark border border-border-subtle rounded-lg px-4 py-3"
                        />
                        {formData.leftImageUrl && (
                            <div className="mt-2 w-16 h-16 rounded-full overflow-hidden border border-border-subtle">
                                <img src={formData.leftImageUrl} alt="Left preview" className="w-full h-full object-cover" />
                            </div>
                        )}
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={(e) => setFormData({ ...formData, rightImageUrl: e.target.value })}
                            placeholder="/img/right-cartoons.png"
                            className="w-full bg-stadium-dark border border-border-subtle rounded-lg px-4 py-3"
                        />
                        {formData.rightImageUrl && (
                            <div className="mt-2 w-16 h-16 rounded-full overflow-hidden border border-border-subtle">
                                <img src={formData.rightImageUrl} alt="Right preview" className="w-full h-full object-cover" />
                            </div>
                        )}
                    </div>

                    <div>
                        <label className="block text-sm text-text-secondary mb-2">Background Image URL (optional)</label>
                        <input
                ...
                <div className="bg-stadium-elevated border border-border-strong rounded-xl p-6 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="block text-sm text-text-secondary mb-2">Start Date (optional)</label>
                            <input
                                type="date"
                        ...
                        <div>
                            <label className="block text-sm text-text-secondary mb-2">End Date (optional)</label>
                            <input
                                type="date"
            ...
            <div className="bg-stadium-elevated border border-border-strong rounded-xl p-6">
                    ...
                    <div className="rounded-xl overflow-hidden relative" style={{ backgroundColor: formData.backgroundColor || "#000" }}>
                        {formData.backgroundImageUrl && (
                            <div className="absolute inset-0">
                                <img src={formData.backgroundImageUrl} alt="Background" className="w-full h-full object-cover opacity-30" />
                            </div>
                        )}
                        ...
                        <div className="relative z-10 p-6 flex items-center gap-6">
                            ...
                            {formData.leftImageUrl && (
                                <div className="w-24 h-24 flex-shrink-0">
                                    <img src={formData.leftImageUrl} alt="Celebrity" className="w-full h-full object-contain" />
                                </div>
                            )}
                            ...
                            <div className="flex-1">
                                ...
                                <button
                                    className="mt-4 px-6 py-3 bg-amber-500 hover:bg-amber-400 text-black font-bold rounded-lg uppercase"
                                >
                                    {formData.ctaText || "CHECK OUR PLANS"}
                                </button>
                            </div>

                            {/* Right - Features */}
                            <div className="flex-shrink-0 space-y-2">
                                <div className="flex items-center justify-between bg-white/10 rounded-lg px-3 py-2 min-w-[180px]">
                                    <span className="text-white text-sm">Watch</span>
                                    <span className="font-bold text-sm" style={{ color: formData.accentColor }}>Full HD</span>
                                </div>
                                <div className="flex items-center justify-between bg-white/10 rounded-lg px-3 py-2">
                                    <span className="text-white text-sm">Download</span>
                                    <span className="font-bold text-sm" style={{ color: formData.accentColor }}>Directly</span>
                                </div>
                                <div className="flex items-center justify-between bg-white/10 rounded-lg px-3 py-2">
                                    <span className="text-white text-sm">Watch</span>
                                    <span className="font-bold text-sm" style={{ color: formData.accentColor }}>Without Ads</span>
                                </div>
                                <div className="flex items-center justify-between bg-white/10 rounded-lg px-3 py-2">
                                    <span className="text-white text-sm">Request</span>
                                    <span className="font-bold text-sm" style={{ color: formData.accentColor }}>Content</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="h-1 bg-white/20">
                            <div className="h-full w-1/3" style={{ backgroundColor: formData.accentColor }} />
                        </div>
                    </div>
                )}
                ...
                {formData.type !== "interstitial" && formData.type !== "popup" && (
                    ...
                    >
                        {formData.leftImageUrl && (
                            <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-blue-500/50 flex-shrink-0">
                                <img src={formData.leftImageUrl} alt="Left" className="w-full h-full object-cover" />
                            </div>
                        )}
                        <div className="flex-1 text-center px-4">
                            ...
                            <button
                                ...
                                style={{ backgroundColor: "#2a4a6a", color: "white" }}
                            >
                                <span style={{ color: formData.accentColor }}>✦</span> {formData.ctaText || "CTA"}
                            </button>
                        </div>
                        {formData.rightImageUrl && (
                            <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-blue-500/50 flex-shrink-0">
                                <img src={formData.rightImageUrl} alt="Right" className="w-full h-full object-cover" />
                            </div>
                        )}
                    </div>
                )}
